def calculates_results_stats(results_dic):
    ...
    Parameters:
      results_dic - Dictionary with key as image filename and value as a List:
             ...
             idx 4 = 1/0 (int)  where 1 = classifier labels image 'as-a' dog and 0 = classifier labels image 'as-NOT-a' dog.
    Returns:
    ...
    for key in results_dic:
        # Increment match count if pet label and classifier label match exactly
